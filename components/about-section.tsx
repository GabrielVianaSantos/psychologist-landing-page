      ...
      <div className="max-w-4xl mx-auto">
        <div className="space-y-8">
          ...
          <div className="space-y-6 text-lg leading-relaxed text-muted-foreground">
            <p>
              {
                "Sou psicóloga, formada pela Universidade Nove de Julho, com especialização em Terapia Cognitivo-Comportamental (TCC) pelo Instituto Unopar Anhanguera. Minha trajetória profissional é guiada pela crença de que cada pessoa carrega, dentro de si, recursos internos capazes de sustentar mudanças reais e uma vida mais equilibrada, mesmo em meio ao caos. Atuo há mais de três anos na clínica, acompanhando pessoas no processo de compreender seus padrões de pensamento, emoções e comportamentos. Acredito que a psicoterapia é uma construção conjunta: uma parceria colaborativa em que, juntos, desenvolvemos estratégias possíveis, éticas e eficazes para o seu desenvolvimento pessoal."
              }
            </p>
            <p>
              {
                "Meu trabalho é fundamentado em evidências científicas, sem jamais perder de vista a singularidade de cada indivíduo. Busco oferecer um espaço acolhedor, seguro e livre de julgamentos, onde você possa se sentir à vontade para explorar suas questões e construir mudanças significativas, no seu tempo e do seu jeito. Sou autora do artigo “Impacto da esquizofrenia nas relações familiares: desafios, estratégias de enfrentamento e apoio psicológico”, publicado na Revista Brasileira de Terapia Familiar. Nesse trabalho, aprofundo os desafios vivenciados por familiares de pessoas com esquizofrenia e destaco a importância do suporte psicológico como ferramenta de cuidado e fortalecimento emocional."
              }
            </p>
            <p>
              {
                "Também tive a honra de participar como coautora da antologia “O ciclo da superprodutividade: trabalhe, produza, adoeça”, ao lado de outros 19 autores. A obra propõe uma reflexão crítica sobre os impactos psicológicos e sociais da cultura do desempenho a qualquer custo, um grito coletivo contra o adoecimento silencioso que se disfarça de sucesso. Essas produções refletem não apenas minha trajetória acadêmica e profissional, mas também meu compromisso com uma psicologia ética, crítica e profundamente humana. Acredito em um cuidado que não patologiza a existência, mas amplia a consciência, fortalece recursos internos e ajuda cada pessoa a construir uma vida que faça sentido, não apesar do mundo em que vivemos, mas em diálogo com ele."
              }
            </p>
          </div>
